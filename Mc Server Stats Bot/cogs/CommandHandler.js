            ...
            switch (interaction.commandName) {
                ...
                case 'botinfo':
                    ...
                    const info = new EmbedBuilder()
                        .setColor('#00FF00')
                        .setTitle(infoTitle)
                        .setURL('https://github.com/Gamer100309/MC-Server-Status-Bot') // Macht den Titel anklickbar
                        .addFields(
                            // HARDCODED DEVELOPER & GITHUB INFO (English)
                            { name: '👨‍💻 Original Developer', value: 'Gamer100309 | RedCity Industries', inline: true },
                            { name: '📂 Source Code', value: '[GitHub Repository](https://github.com/Gamer100309/MC-Server-Status-Bot)', inline: true },
                            { name: '\u200B', value: '\u200B', inline: false }, // Unsichtbarer Trenner für sauberes Layout
                            
                            // Multi-language statistics fields
                            ...
                            { name: versionLabel, value: 'v5.1.0 Stable', inline: true }
                        )
                        .setFooter({ text: footerText });
                    
                    await interaction.reply({ embeds: [info], ephemeral: true });
                    this.logger.success(`Botinfo (incl. GitHub) gesendet an ${interaction.user.tag}`);
                    break;
